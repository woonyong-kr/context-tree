...
6. Reload Obsidian; verify follow, single graph creation per navigation, movable current node, invisible parent affordance, hover-only second-hop preview, responsive canvas use, metadata colours, direct navigation, collapse, search, empty state, and no Vault writes.
