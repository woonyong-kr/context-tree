...
/**
 * Expands each explicit seed by a bounded number of Vault-link hops. This is
 * deliberately a projection, not a crawler: missing files and excluded paths
 * fail closed, and depth is already bounded by the profile parser.
 */
